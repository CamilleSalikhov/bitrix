...
<?if(!empty($arResult["ITEMS"]) ):?>
	...
	?>
      ...
      data-stellar-background-ratio="0.5">
			<?else:?>
				<div id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="site-blocks-cover" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/images/hero_bg_1.jpg);" data-aos="fade"
      data-stellar-background-ratio="0.5">
			<?endif;
      ...
      <div class="text">
        ...
        <p class="location"><!-- <span class="property-icon icon-room"></span> --> <?=isset($arItem["PREVIEW_TEXT"]) ? $arItem["PREVIEW_TEXT"] : "";?></p>
